...
const mockUserProvider = vi.fn(({ children }) => <div data-testid="user-provider-mock">{children}</div>);

// Mock UserContext module
vi.mock('../context/UserContext', () => ({
  UserProvider: (props: { children: React.ReactNode }) => mockUserProvider(props),
}));
